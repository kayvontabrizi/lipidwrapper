...
def get_commandline_parameters(argv: list):
    ...
    )  # used if surface_source is set to "EQUATION"
    ...
    params["lipid_headgroup_marker"] = (
        "_P,CHL1_O3"
    )  # by default, any phosphate atom is considered a marker for the lipid headgroup, and also any O3 atom belonging to a cholesterol
    ...
    if (
        ...
        and params["number_of_processors"] > 1
    ):
